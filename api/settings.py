...
# Taken directly from your Neon screenshot (passwordless auth ON is fine with this)
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': 'neondb',
        'USER': 'neondb_owner',
        'PASSWORD': 'npg_Li4kUbBVF6Ye',  # This is correct when passwordless is enabled
        'HOST': 'ep-withered-pond-adouzkvu.c-2.us-east-1.aws.neon.tech',
        'PORT': '5432',
        'OPTIONS': {
            'sslmode': 'require',
            'channel_binding': 'require',  # Required when passwordless auth is ON
        },
